...
export const ALLOWED_PHASE_TRANSITIONS: Readonly<Record<GamePhase, readonly GamePhase[]>> = {
  ...
  MOVING: ['LANDING', 'FLIGHT_DECISION'],
  FLIGHT_DECISION: [
    'MOVING',
    'FLIGHT_DECISION',
    'LANDING',
  ...
  PAYMENT: ['PAYMENT', 'TURN_END', 'TURN_START', 'ROUND_EVENT', 'GAME_OVER'],
  CARD_EVENT: ['PAYMENT', 'TURN_END'],
  ROUND_EVENT: ['TURN_START', 'GAME_OVER'],
  TRADE: ['TRADE', 'TURN_START', 'TURN_END'],
  AUCTION: ['AUCTION', 'TURN_END'],
  JAIL: ['ROLLING', 'MOVING', 'FLIGHT_DECISION', 'TURN_END'],
  TURN_END: ['TURN_END', 'TURN_START', 'ROUND_EVENT', 'TRADE', 'GAME_OVER'],
  GAME_OVER: []
};
